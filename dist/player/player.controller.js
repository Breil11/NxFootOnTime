...
let PlayerController = class PlayerController {
    ...
    updatePartialPlayer(id, updatePlayerDto) {
        const teamId = 1;
        const updateTeamDto = {};
        return this.playerService.updatePlayerTeam(id, teamId, updatePlayerDto, updateTeamDto);
    }
};
__decorate([
    (0, common_1.Get)(),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, player_dto_1.UpdatePlayerDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], PlayerController.prototype, "updatePartialPlayer", null);
