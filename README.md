...
export class Nxfoot1687168711259 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    const foreignKey = playerTable.foreignKeys.find(
      (fk) => fk.columnNames.indexOf('teamId') !== -1,
    );
    await queryRunner.dropForeignKey('player', foreignKey);
